...
$root=dirname(__DIR__); $dir=$root.'/data/aventura/art/islet';
...
foreach($catalog['frames'] as $frame) {
    ...
    $frames[$sprite]=array_merge($frame,['source'=>"data/aventura/art/islet/cutouts/$id.png",'fit'=>true]);
}
file_put_contents($root.'/data/aventura/assets/islet-garden.json',json_encode(['frames'=>$frames],JSON_PRETTY_PRINT|JSON_UNESCAPED_SLASHES)."\n");
