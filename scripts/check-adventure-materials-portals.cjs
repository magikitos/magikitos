...
try {
  ...
  for (const item of ["world.php", "catalog.json", "residents.json", "elements.json", "homesteads.json", "construction.json", "resource-nodes.json", "scene-instances.json", "scenes", "behaviors"])
