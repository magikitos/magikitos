...
| GET catalog | kind=products or art; cursor; optional collection ID for art | Up to 24 products, art collections or sheets; nextCursor |
...
image and url. Art collections expose id, title, image and url. Sheet responses
include their public collection and id/title/image for each sheet.
