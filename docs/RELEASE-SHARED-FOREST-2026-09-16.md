...
Historical API/economy rollout. The subsequent static-only
[controls, cats and docks release](RELEASE-CONTROLS-2026-09-16.md) is now active;
the schema, backups and example-account record below remain valid.
